  ...
  return (
    <header className="bg-surface/80 backdrop-blur-md border-b border-outline-variant shadow-[0px_12px_32px_rgba(30,41,59,0.04)] flex justify-between items-center w-full px-6 py-4 sticky top-0 z-50">
      <div className="flex items-center gap-4">
        <div className="w-10 h-10 rounded-full overflow-hidden bg-surface-container flex-shrink-0 ring-2 ring-white/10 shadow-sm">
          <img 
            alt="User profile photo" 
            className="w-full h-full object-cover" 
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuDkODb-CPJ9xW-Xln4R5LY80bGX-jxNbVDSgxKzdG_zF_uPBnxbW6l6kZSr5nTnnUjUoPulRf9AlyKvqIuAC7Qd4Vnbq4u24y6czp5h3tXPDI5nFo-M7PGe96-h-gzqFojZ_f-G2sYBItnp9HJxNTLqTWGSfZkEPH4fN7RACaPq_5ukr_89s74Gmp9KJvvqiDjSO_PpvXFFgPUjXM0R_uxae1WRiFn3kKKUThJosyxgqJV-BXKxEu3d_c79ezyRE4nXv5lKZlxo9l5H" 
          />
        </div>
        <span className="text-lg font-bold tracking-tight text-primary font-sans">Tracker</span>
      </div>
